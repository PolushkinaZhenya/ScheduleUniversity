...
namespace ScheduleDatabaseImplementations.Implementations
{
	public class StudyGroupServiceDB : IStudyGroupService
    {
        ...
        private static StudyGroup GetModel(StudyGroupBindingModel model, StudyGroup entity = null)
		{
            if (model == null) return null;
            if (entity == null) entity = new StudyGroup { Id = Guid.NewGuid() };

            entity.Title = model.Title;
            entity.SpecialtyId = model.SpecialtyId;
            entity.TypeEducation = model.TypeEducation;
            entity.FormEducation = model.FormEducation;
            entity.Course = model.Course;
            entity.GroupNumber = model.GroupNumber;
            entity.NumderStudents = model.NumderStudents;
            entity.NumderSubgroups = model.NumderSubgroups;
