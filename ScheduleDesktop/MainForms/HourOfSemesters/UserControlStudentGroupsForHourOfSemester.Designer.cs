...
{
	partial class UserControlStudentGroupsForHourOfSemester
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.tabControlLoads.SelectedIndexChanged += new System.EventHandler(this.TabControlLoads_SelectedIndexChanged);
			// 
			// UserControlStudentGroupsForHourOfSemester
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(7F, 15F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this.tabControlLoads);
			this.Controls.Add(this.listBoxStudentGroups);
			this.Name = "UserControlStudentGroupsForHourOfSemester";
